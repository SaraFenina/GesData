...
print("Indice où se trouve 15 :", recherche_grand_niveau(test, valeur)) # Il est attendu d'avoir 2
...
print("Indice où se trouve 13 :", recherche_grand_niveau(test, valeur)) #-1
...
print("Indice où se trouve 42 :", recherche_grand_niveau(test, valeur)) #0

# TEST 4
print("---------------------------------------------------------------------------")
print("TEST 4 : Un seul élément dans la liste (valeur absente)")
valeur = 10
print("Indice où se trouve 10 :", recherche_grand_niveau(test, valeur)) #-1
...
print("Indice (quelconque) d’un 10 trouvé :", recherche_grand_niveau(test, valeur))  #4
...
print("Indice (quelconque) d’un 10 trouvé :", recherche_grand_niveau(test, valeur))  #5
...
test = [
    ...
    Formation("Science", "Chimie", 20),
    Formation("Science", "Informatique", 20),
    Formation("Lettres", "Philosophie", 25)]
valeur = 15

print("Indice d’un 10 trouvé :", recherche_grand_niveau(test, valeur)) #1
...
test = [
    ...
    Formation("Science", "Informatique", 45),
    Formation("Lettres", "Philosophie", 45)]
valeur = 45

print("Indice d’un 10 trouvé :", recherche_grand_niveau(test, valeur)) #4
