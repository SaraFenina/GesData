...
print("Indice où se trouve 15 :", recherche_dicho_niveau(test, valeur)) # Il est attendu d'avoir 2
...
print("Indice où se trouve 13 :", recherche_dicho_niveau(test, valeur)) #-1
...
print("Indice où se trouve 42 :", recherche_dicho_niveau(test, valeur)) #0

# TEST 4
print("---------------------------------------------------------------------------")
print("TEST 4 : Un seul élément dans la liste (valeur absente)")
valeur = 10
print("Indice où se trouve 10 :", recherche_dicho_niveau(test, valeur)) #-1
...
print("Indice (quelconque) d’un 10 trouvé :", recherche_dicho_niveau(test, valeur))  #2
...
test = [
    ...
    Formation("Lettres", "Philosophie", 30)]
valeur = 15

print("Indice d’un 10 trouvé :", recherche_dicho_niveau(test, valeur)) #0
...
test = [
    Formation("Science", "Maths", 5),
    Formation("Science", "Physique", 10),
    Formation("Science", "Chimie", 25),
    Formation("Science", "Informatique", 30),
    Formation("Lettres", "Philosophie", 30)]
valeur = 30

print("Indice d’un 10 trouvé :", recherche_dicho_niveau(test, valeur)) #3
